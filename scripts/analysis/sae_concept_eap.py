"""Phase 4.11/6 SAE feature attribution for concept-margin circuits."""
...
from diffmechint.probing.concepts import get_concept  # noqa: E402
...
def run_concept_eap(args: argparse.Namespace) -> int:
    ...
    for condition in args.conditions:
        manifest = _manifest(args.activations_root, condition, args.dit_step)
